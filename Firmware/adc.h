...
#define BITCOUNT16(x) (BITCOUNT((x) & 0xff) + BITCOUNT(((x) >> 8) & 0xff))

#define ADC_PIN_IDX(pin) BITCOUNT16(ADC_CHAN_MSK & ((uint16_t)(1 << (pin)) - 1))

#if BITCOUNT16(ADC_CHAN_MSK) != ADC_CHAN_CNT
