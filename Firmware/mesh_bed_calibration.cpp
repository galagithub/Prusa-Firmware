...
const float bed_ref_points_4[] PROGMEM = {
	...
	18.4f - BED_PRINT_ZERO_REF_Y - Y_PROBE_OFFSET_FROM_EXTRUDER - SHEET_PRINT_ZERO_REF_Y, // 18.4-9.4-5-2=2 (MK3) 18.4-9.4-5-0=4 (MK25)

	245.f - BED_PRINT_ZERO_REF_X - X_PROBE_OFFSET_FROM_EXTRUDER  - SHEET_PRINT_ZERO_REF_X, // 245-2-23-0=220
	18.4f - BED_PRINT_ZERO_REF_Y - Y_PROBE_OFFSET_FROM_EXTRUDER - SHEET_PRINT_ZERO_REF_Y, // 18.4-9.4-5-2=2 (MK3) 18.4-9.4-5-0=4 (MK25)

	245.f - BED_PRINT_ZERO_REF_X - X_PROBE_OFFSET_FROM_EXTRUDER  - SHEET_PRINT_ZERO_REF_X, // 245-2-23-0=220
	210.4f - BED_PRINT_ZERO_REF_Y - Y_PROBE_OFFSET_FROM_EXTRUDER - SHEET_PRINT_ZERO_REF_Y, // 210.4-9.4-5-2=194 (MK3) 210.4-9.4-5-0=196 (MK25)
