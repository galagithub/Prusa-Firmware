...
// Printer Frame, used for bed calibration
#define ORBALLO_P3STEEL_FRAME
...
// New XYZ calibration
//#define NEW_XYZCAL
// NEW_XYZCAL is commented out in MK2 config file as well
